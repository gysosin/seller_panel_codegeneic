...
<head>
    ...
    <title>Dashboard ecommerce - Vuesax - Bootstrap HTML admin template</title>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href='/dashboard-returnorders'><i class="feather icon-calendar"></i><span class="menu-title" data-i18n="Calender">Failed</span></a>
                </li> 
                </ul> </li>
